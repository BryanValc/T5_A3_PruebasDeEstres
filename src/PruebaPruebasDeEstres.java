...
class MetodosOrdenamiento{
	static long resultados[][][]=new long[4][11][4];
	...
	static class Intercalacion{
		...
		public static void ordenacionIntercalacion(int nums[],int np) {
			...
			resultados[np][8][0]=comparaciones;
			resultados[np][8][1]=intercambios;
			resultados[np][8][2]=recorridos;
			resultados[np][8][3]=fin-ini;
		}
...
public class PruebaPruebasDeEstres {
	...
	public static void main(String[] args) {
		...
		String metodos[]= {"Burbuja1","Burbuja2","Burbuja3","Insercion","Seleccion","Quicksort","Shellsort","Radix	","Intercalacion","Mezcla directo","Mezcla natural"};
		for (int i = 0; i < 4; i++) {
			...
			System.out.println("Itercalacion"+nums.length+" numeros terminada...");
